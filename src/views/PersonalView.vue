<template>
    <div class="max-w-screen-sm mx-auto px-4 py-10">
        ...
        <div class=" max-w-screen-sm mx-auto px-4 py-10">
            ...
            <p class="text-l">Thank you for agreeing to do this questionnaire with us today.
        ...
        <div class="p-8 flex ">
            <form @submit.prevent="recordPersonals" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
                ...
                <div class="flex flex-col">
                 ...
                 <select @change="choiceChange" id="consent-Choice" class="mx-auto mt-8 p-2 text-gray-500 focus:outline-none" required v-model="consentChoice">
